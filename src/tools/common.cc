...
bool Common::ConfDiff(const std::filesystem::path &origin_file,
...
bool Common::ConfReplace(const std::filesystem::path &origin_file,
                         const std::filesystem::path &final_file,
                         std::string *out) {
  if (!std::filesystem::exists(origin_file)) {
    *out = origin_file.string() + " replace error, origin file not exists";
...
bool Common::ConfGen(const std::filesystem::path &origin_file,
                     std::string *out) {
  if (!std::filesystem::exists(origin_file)) {
