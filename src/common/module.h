...
// ===========================================================================
// in main.cpp
#include "oceandoc/common/module.h"
...
inline void InitAllModules(int* argc, char*** argv, bool remove_flags = true) {
  ::oceandoc::common::internal::ModuleManager::InitializeAll(
...
#define DEFINE_MODULE(name)                                                    \
  ...
  ::oceandoc::common::internal::ModuleRegisterer                         \
...
#define DEFINE_MODULE_DTOR(name)                                             \
  ...
  namespace modules {                                                        \
  PP_DISALLOW_IN_HEADER_FILE()                                               \
  ::oceandoc::common::internal::ModuleDtorRegisterer                   \
  ...
  static void name##_ModuleDtor() {                                          \
    ::oceandoc::common::internal::ModuleManager::LogModuleDtor(#name); \
    name##_DoModuleDtor();                                                   \
  }                                                                          \
  static void name##_DoModuleDtor()
...
#define USING_MODULE(dep_name)                                                 \
  namespace modules {                                                          \
  PP_DISALLOW_IN_HEADER_FILE()                                                 \
  extern ::oceandoc::common::internal::ModuleRegisterer                  \
      dep_name##_module_registerer;                                            \
  static ::oceandoc::common::internal::ModuleDependencyRegisterer        \
