...
genrule(
    ...
    srcs = [
        "@freetype_config//:freetype-android/freetype/config/ftmodule.h",
        "@freetype_config//:freetype-android/freetype/config/ftoption.h",
    ],
    outs = [
    ...
    cmd_bat = "for %f in ($(SRCS)) do copy %f $(RULEDIR)\\builds\\skia\\android\\freetype\\config",
)
...
genrule(
    ...
    srcs = [
        "@freetype_config//:freetype-no-type1/freetype/config/ftmodule.h",
        "@freetype_config//:freetype-no-type1/freetype/config/ftoption.h",
    ],
    outs = [
    ...
    cmd_bat = "for %f in ($(SRCS)) do copy %f $(RULEDIR)\\builds\\skia\\no-type1\\freetype\\config",
)
