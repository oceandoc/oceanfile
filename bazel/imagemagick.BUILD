...
COPTS = GLOBAL_COPTS + select({
    ...
    "//conditions:default": [
        ...
        "-O3",
        "-fPIC",
        "-Iexternal/imagemagick/Magick++",
        "-Iexternal/imagemagick/Magick++/lib/Magick++",
...
write_file(
    name = "magick-baseconfig_h_in_tmp",
    out = "magick-baseconfig.h.in.tmp",
    content = [
        ...
        "#define MAGICKCORE_PACKAGE_STRING \"ImageMagick 7.1.1-42\"",
        "#endif",
        "",
        ...
        "#define MAGICKCORE_PACKAGE_VERSION \"7.1.1-42\"",
        "#endif",
        "",
...
template_rule(
    name = "magick-baseconfig_h_tmp",
    src = ":magick-baseconfig_h_in_tmp",
    out = "magick-baseconfig.h.tmp",
...
genrule(
    name = "move_magick_baseconfig_h",
    srcs = [":magick-baseconfig_h_tmp"],
    outs = ["MagickCore/magick-baseconfig.h"],
    cmd = "cp $(location :magick-baseconfig_h_tmp) $@",
)
#cmd = "mkdir -p $(@D)/MagickCore && cp $(location :magick-baseconfig_h_tmp) $(@D)/MagickCore/magick-baseconfig.h",
